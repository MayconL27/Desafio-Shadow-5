...
public class UsuariosController {
    ...
    @PostMapping(value = "/salvar") // Salvar Usuários.
    ...
    @GetMapping("/{id}") // Buscar por ID do usuário.
    public ResponseEntity<Object> buscarPorId(@PathVariable(value = "id")UUID codigoID,
                                              @RequestHeader(HttpHeaders.AUTHORIZATION)String token) {
